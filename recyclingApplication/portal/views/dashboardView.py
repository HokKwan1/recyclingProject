...
def createCityCountBreakdownChart():
    ...
    completed_counts = [data['completed'] for data in chart_data.values()]
    in_progress_counts = [data['in_progress'] for data in chart_data.values()]
    pending_counts = [data['pending'] for data in chart_data.values()]
